...
static camera_config_t camera_config = {
    ...
    .pixel_format = PIXFORMAT_JPEG, //YUV422,GRAYSCALE,RGB565,
    ...
    // .fb_count = 16,       //When jpeg mode is used, if fb_count more than one, the driver will work in continuous mode.
    // .grab_mode = CAMERA_GRAB_WHEN_EMPTY
};
